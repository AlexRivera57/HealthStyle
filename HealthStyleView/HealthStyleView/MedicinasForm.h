...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		Medicines^ medicine = gcnew Medicines();
		//PersonalCareProduct->setId(Convert::ToInt32(txtPersonalCareId->Text));
		medicine->Id = Convert::ToInt32(txtMedicineId->Text);
		medicine->Name = txtMedicineName->Text;
		medicine->Description = txtMedicineDescription->Text;
		medicine->Price = Convert::ToDouble(txtMedicinePrice->Text);
		//product->PriceMaj = Convert::ToDouble(txtPersonalCarePriceMaj->Text);
		medicine->Stock = Convert::ToInt32(txtMedicineStock->Text);
		...
		ShowMedicines();
		   ...
		   void ShowMedicines() {
			   ...
			   List<Medicines^>^ myMedicineList = Controller::QueryAllMedicines();
...
private: System::Void dgvMedicine_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	...
	Medicines^ p = Controller::QueryMedicineById(medicineId);
