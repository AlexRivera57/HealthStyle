...
namespace HealthStyleView {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ historialMedicoToolStripMenuItem1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->historialMedicoToolStripMenuItem1 = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->mantenimientoToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->pacientesToolStripMenuItem,
					this->doctoresToolStripMenuItem, this->enfermerosToolStripMenuItem, this->medicinasToolStripMenuItem, this->historialMedicoToolStripMenuItem1
			});
			...
			this->pacientesToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			...
			this->doctoresToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			...
			this->enfermerosToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			...
			this->medicinasToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			...
			// 
			// historialMedicoToolStripMenuItem1
			// 
			this->historialMedicoToolStripMenuItem1->Name = L"historialMedicoToolStripMenuItem1";
			this->historialMedicoToolStripMenuItem1->Size = System::Drawing::Size(161, 22);
			this->historialMedicoToolStripMenuItem1->Text = L"Historial Medico";
			this->historialMedicoToolStripMenuItem1->Click += gcnew System::EventHandler(this, &HealthStyleMainForm::historialMedicoToolStripMenuItem1_Click);
			// 
...
private: System::Void historialMedicoToolStripMenuItem1_Click(System::Object^ sender, System::EventArgs^ e) {
