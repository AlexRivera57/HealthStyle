...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(336, 34);
			...
			this->label4->Location = System::Drawing::Point(336, 66);
			...
			this->label5->Location = System::Drawing::Point(336, 97);
			...
			this->label10->Location = System::Drawing::Point(310, 239);
			...
			this->label12->Location = System::Drawing::Point(36, 270);
			...
			this->label13->Location = System::Drawing::Point(310, 273);
			...
			this->label14->Location = System::Drawing::Point(36, 313);
			...
			this->label15->Location = System::Drawing::Point(310, 309);
			...
			this->txtName->Size = System::Drawing::Size(174, 20);
			...
			this->txtLastName->Size = System::Drawing::Size(174, 20);
			...
			// txtYearsOfWork
			// 
			this->txtYearsOfWork->Location = System::Drawing::Point(425, 239);
			...
			// txtSchedule
			// 
			this->txtSchedule->Location = System::Drawing::Point(425, 270);
			this->txtSchedule->Name = L"txtSchedule";
			this->txtSchedule->Size = System::Drawing::Size(133, 20);
			this->txtSchedule->TabIndex = 41;
			// 
			// txtPatientsAttended
			// 
			this->txtPatientsAttended->Location = System::Drawing::Point(426, 306);
			...
			this->dgvNurses->Size = System::Drawing::Size(588, 100);
			...
			this->cmbSpeciality->Size = System::Drawing::Size(155, 21);
			...
			this->groupBox1->Location = System::Drawing::Point(87, 294);
			...
			this->ClientSize = System::Drawing::Size(615, 504);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	n->Status = rbtnDisponible->Checked ? 'D' : 'N';
	n->Speciality = cmbSpeciality->Items[index]->ToString();
...
void ShowNurses() {
	...
	for (int i = 0; i < NursesList->Count; i++) {
		String^ statusString = NursesList[i]->Status == 'D' ? "Disponible" : "No Disponible";
...
private: System::Void dgvNurses_CellContentClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	...
	int nurseId = Convert::ToInt32(dgvNurses->Rows[selectedRowIndex]->Cells[0]->Value->ToString());
