...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->gBoxGender->Location = System::Drawing::Point(104, 219);
			this->gBoxGender->Name = L"gBoxGender";
			this->gBoxGender->Size = System::Drawing::Size(102, 47);
			this->gBoxGender->TabIndex = 44;
			this->gBoxGender->TabStop = false;
			// 
			// rbtnFemale
			// 
			this->rbtnFemale->AutoSize = true;
			this->rbtnFemale->Location = System::Drawing::Point(60, 19);
			...
			this->rbtnMale->Size = System::Drawing::Size(36, 17);
			this->rbtnMale->TabIndex = 0;
			this->rbtnMale->TabStop = true;
			this->rbtnMale->Text = L"Sí";
			this->rbtnMale->UseVisualStyleBackColor = true;
			// 
			// dtpBirthday
			// 
			this->dtpBirthday->Location = System::Drawing::Point(380, 193);
			...
			// txtPhoneNumber
			// 
			this->txtPhoneNumber->Location = System::Drawing::Point(104, 193);
			...
			// txtEmail
			// 
			this->txtEmail->Location = System::Drawing::Point(104, 158);
			...
			// txtAddress
			// 
			this->txtAddress->Location = System::Drawing::Point(104, 125);
			...
			// txtDNI
			// 
			this->txtDNI->Location = System::Drawing::Point(414, 95);
			...
			// txtLastName
			// 
			this->txtLastName->Location = System::Drawing::Point(104, 95);
			...
			// txtPassword
			// 
			this->txtPassword->Location = System::Drawing::Point(414, 64);
			...
			// txtUsername
			// 
			this->txtUsername->Location = System::Drawing::Point(414, 32);
			...
			// txtName
			// 
			this->txtName->Location = System::Drawing::Point(104, 64);
			...
			this->label13->Location = System::Drawing::Point(328, 67);
			...
			// txtId
			// 
			this->txtId->Location = System::Drawing::Point(104, 32);
			...
			this->label8->Location = System::Drawing::Point(277, 196);
			...
			this->label7->Location = System::Drawing::Point(35, 196);
			...
			this->label6->Location = System::Drawing::Point(35, 161);
			...
			this->label5->Location = System::Drawing::Point(35, 128);
			...
			this->label4->Location = System::Drawing::Point(328, 98);
			...
			this->label3->Location = System::Drawing::Point(35, 98);
			...
			this->label9->Location = System::Drawing::Point(35, 238);
			...
			this->dataGridView1->Location = System::Drawing::Point(38, 272);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(536, 135);
			...
			this->ClientSize = System::Drawing::Size(621, 423);
